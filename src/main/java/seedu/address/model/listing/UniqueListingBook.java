 ...
 * listings uses Listing#isSameListing(Listing) for equality so as to ensure that the person being added or updated is
 * unique in terms of identity in the UniqueListingList. However, the removal of a person uses Listing#equals(Object) so
 ...
 */
public class UniqueListingBook implements Iterable<Listing> {
    ...
    public void setListings(UniqueListingBook replacement) {
    ...
    public boolean equals(Object other) {
        return other == this // short circuit if same object
                || (other instanceof UniqueListingBook // instanceof handles nulls
                        && internalList.equals(((UniqueListingBook) other).internalList));
    }
